  ...
  try {
    const user = await prisma.user.findUnique({
      ...
      select: {
        ...
        currentObsession: true,
        endlessTopic: true,
        curiousThoughts: true,
        energizingConversations: true,
        excitedInConversation: true,
        conversationComfort: true,
        handlingTension: true,
        presenceTriggers: true,
        groundingPractices: true,
        patternsToMoveBeyond: true,
        growthThroughChallenge: true,
        connectionComfortLevel: true,
        buildExploreCreate: true,
        closingOffTriggers: true,
        feelingMostMyself: true,
